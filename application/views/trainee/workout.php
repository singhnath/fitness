...
<div class="container-fluid">
  ...
  <div class="widget-content nopadding">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" name="form" action="<?= base_url('index.php/workout/workout_submit') ?>" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover text-center">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url("index.php/workout/edit_workout").'/'.$value['id']; ?>" title="edit"><i class="fa fa-pencil-square" aria-hidden="true"></i></a> <a href="<?php echo base_url("index.php/workout/delete_workout").'/'.$value['id']; ?>" title="edit"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                    </tr>
                    <?php
                    $num++;
                  }
