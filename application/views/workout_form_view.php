      ...
      <div class="span12">
        ...
        <div class="widget-box">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?=isset($workout_plan_id)?base_url('/workout/workout_plan_update/'.$workout_plan_id):base_url('/workout/workout_plan_add')?>" method="post" name="form">
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-5">
                             <div class="form-group">
                                ...
                                <?php if( isset($trainees) && !empty($trainees)){ foreach ($trainees as $key=> $trainee){ ?>
                                   ...
                                   <option  <?php if (isset($trainee_row)) {
                                     $trainee_row_id = isset($trainee_row['trainee_id'])?$trainee_row['trainee_id'] :'';
                                ...
                                <div class="error"><?=form_error('trainee_id')?></div>
                            </div>
                        </div>
                        <div class="col-xs-5">
                             <div class="form-group">
