      ...
      <div class="span12">
        ...
        <div class="widget-box">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?=isset($workout_plan_id)?base_url('/workout/workout_plan_update/'.$workout_plan_id):base_url('/workout/workout_plan_add')?>" method="post" name="form" id="workout_plan_form">
                <div class="box-body">
                    <div class="row">
                      <div class="col-xs-10">
