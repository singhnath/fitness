...
<div class="container-fluid">
  ...
  <div class="widget-content nopadding">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" name="form" action="<?= base_url('index.php/trainers/workout_submit') ?>" enctype="multipart/form-data" id="workout_form">
              <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover text-center">
                ...
                <tbody>
                  ...
                  <tr id="<?=$value['id']?>">
                    ...
                    <td><a href="<?php echo base_url("trainers/edit_workout").'/'.$value['id']; ?>" title="edit"><i class="fa fa-pencil-square" aria-hidden="true"></i></a> <a href="#" title="delete" ><i class="fa fa-trash remove_workout" aria-hidden="true"></i></a></td>
                    </tr>
                    <?php 
                    $num++;
                  }
