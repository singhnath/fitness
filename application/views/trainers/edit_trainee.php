        ...
        <div class="col-md-12">
         ...
         <!-- form start -->
           ...
           <!--      <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="trainee_password" id="exampleInputPassword1" placeholder="Password" value="<?= $data['UserPassword'];?>disabled" >
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <a href="<?=base_url('trainers/trainee_change_password/'.$data['ID']);?>" class="btn btn-primary"  style="margin: 20px;">Change Password</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
